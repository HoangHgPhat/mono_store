                                ...
                                <div class="account-wrap" style="flex-flow: row-reverse;">
                                    <div class="account-item clearfix js-item-menu">
                                        ...
                                        <div class="content">
                                            ...
                                            <a class="js-acc-btn" href="#">{{Session::get('loginID')}}</a>
                                            @if (Session::has('loginIDcus')) 
                                                <a class="js-acc-btn">Wellcome {{Session::get('loginIDcus')}}</a> 
                                            @else 
                                            <a class="js-acc-btn" href="{{url('loginAdmin')}}" class="nav__link">Logout</a> 
                                            @endif
                                        </div>
